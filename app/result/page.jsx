...
export default function ResultPage() {
  ...
  const img = params.get("img"); // ссылка на фото
  const blob = params.get("blob"); // blob URL если загружено
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center text-white px-6">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-30 -z-10">
        <div className="w-[900px] h-[900px] rounded-full bg-gradient-to-br from-[#4a7cff33] via-[#8456ff33] to-[#ff45ff22] blur-[160px]" />
      </div>
      ...
      <div className="max-w-2xl w-full text-center animate-fade">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-8 rounded-2xl shadow-[0_0_30px_rgba(130,150,255,0.2)] mb-10 text-left">
          ...
          {loading ? (
            <p className="text-gray-300 animate-pulse">Analyzing your energy…</p>
          ) : (
          ...
          <p className="text-gray-400 mt-6 text-sm">
            Unlock the full 7-parameter attractiveness breakdown, deep emotional aura reading, opposite-gender perception, your personal archetype, and professional improvement advice.
          </p>
        </div>
